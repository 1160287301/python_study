...
function search(keyword,redo) {
    ...
    var postchannel = $("input[name='postchannel']").length > 0 && $("input[name='postchannel']").val() != '' ? $("input[name='postchannel']").val() : '0000';
    var issuedate = '9';
    var lonlat = '0,0';
    var ord_field = '0';
    var dibiaoid = '0';
...
function jobview(jobid) {
    ...
    img.src = window.cfg.domain.jobs + '/ajax/addview.php?jobid=' + jobid + '&' + Math.random();
}